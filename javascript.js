...
function verificarCampos() {
    if (descriTarefaElement.value.trim() != "" && nivelPrioElement.value != "" && prazoElement.value != "" && prazoElement.value != "" && statusElement.value != "") {
        return true;
    } else {
        return false;
    }
...
function renderizarLista() {
    ...
    for (todos of todosList) {
        ...
        btnEx.setAttribute('onclick', 'deleteTodo(' + todosList.indexOf(todos) + ')');
